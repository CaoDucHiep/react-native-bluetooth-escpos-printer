...
public class RNBluetoothEscposPrinterModule
  ...
  public RNBluetoothEscposPrinterModule(
  ...
  public void printText(
    ...
    try {
      ...
      if (options != null) {
        encoding =
          options.hasKey("encoding") ? options.getString("encoding") : "GBK";
        codepage = options.hasKey("codepage") ? options.getInt("codepage") : 0;
        widthTimes =
          options.hasKey("widthtimes") ? options.getInt("widthtimes") : 0;
        heigthTimes =
          options.hasKey("heigthtimes") ? options.getInt("heigthtimes") : 0;
      ...
      byte[] bytes = PrinterCommand.POS_Print_Text(
        toPrint,
        encoding,
        codepage,
        widthTimes,
  ...
  public void printPic(String base64encodeStr, @Nullable ReadableMap options) {
    ...
    if (mBitmap != null) {
       ...
       * Returns: byte[]
       */
      byte[] data = PrintPicture.POS_PrintBMP(
        mBitmap,
        width,
        nMode,
        leftPadding
  ...
  public void printBarCode(
    ...
    byte[] command = PrinterCommand.getBarCodeCommand(
      str,
      nType,
      nWidthX,
      nHeight,
  ...
  private boolean sendDataByte(byte[] data) {
    if (
      data == null || mService.getState() != BluetoothService.STATE_CONNECTED
    ) {
      return false;
    }
    mService.write(data);
